...
class DeplacerArriereTest {
    ...
    Tuile t21 = new Tuile(4, false);
    Ligne l7 = new Ligne(List.of(t19, t20, t21));

    Tuile t22 = new Tuile(0, true);
    Tuile t23 = new Tuile(2, false);
    Tuile t24 = new Tuile(2, false);
    ...
    /**
     * test 4 X X  | X 4 X  | X X 4
     * test 2 X 2  | 2 2 2  | X 2 2
     * test X X X  | X X X  | X X X
     * but
     * test X X X  | X X X  | 4 4 4
     * test X X X  | X X 2  | 4 4 4
     * test X X X  | X X X  | X X X
     */
    @Test
    void testDeplacement() {
        j1.deplacerArrierre();
        assertEquals("------------------[    ][    ][    ]------------------[    ][    ][    ]------------------[    ][    ][    ]------------------------------------[    ][    ][    ]------------------[    ][    ][  2 ]------------------[    ][    ][    ]------------------------------------[  4 ][  4 ][  4 ]------------------[  4 ][  4 ][  4 ]------------------[    ][    ][    ]------------------", j1.getStringGrille());
    }
}
